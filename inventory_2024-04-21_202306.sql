...
) ENGINE=InnoDB AUTO_INCREMENT=10000004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_friends` (
  `TheUserId` bigint unsigned NOT NULL,
...
CREATE TABLE `t_friendsrequest` (
  ...
  CONSTRAINT `t_friendsrequest_ibfk_3` FOREIGN KEY (`TargetGroupId`) REFERENCES `t_relationtree` (`id`)
...
CREATE TABLE `t_group` (
  ...
  `CreatorUserId` bigint unsigned DEFAULT NULL,
...
--
-- Table structure for table `t_grouprequest`
--

DROP TABLE IF EXISTS `t_grouprequest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_grouprequest` (
  `Id` int NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `UserId` bigint unsigned DEFAULT NULL,
  `TargetGroupId` bigint unsigned DEFAULT NULL,
  `ReqMsg` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
CREATE TABLE `t_messagerecord` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_msgbox` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `username` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `targetfont` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '发送者',
  `targetImage` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `isNew` tinyint DEFAULT NULL,
  `Type` enum('person','group') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'person' COMMENT '盒子类型',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_onlieuser` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4040 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_relationtree` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `ownerId` bigint DEFAULT NULL COMMENT '所有者id',
...
CREATE TABLE `t_relationtreemember` (
  ...
  `nameId` bigint unsigned DEFAULT NULL COMMENT '在组中的成员',
  PRIMARY KEY (`id`),
  KEY `groupId` (`groupId`),
  KEY `nameId` (`nameId`),
  CONSTRAINT `t_relationtreemember_ibfk_1` FOREIGN KEY (`groupId`) REFERENCES `t_relationtree` (`id`)
...
CREATE TABLE `t_usergroups` (
  ...
  `Role` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '成员',
...
-- Dump completed on 2024-04-21 20:23:10
