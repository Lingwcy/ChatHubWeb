...
<template>
    <svg  v-if="props.logoType == 'NavWindow'" viewBox="0 0 303.39309471993107 93" preserveAspectRatio="xMidYMid meet" class="css-8aabad" id="efeegbec">
        ...
        <g id="SvgjsG1495" featurekey="symbolFeature-0"
            transform="matrix(0.08974358974358974,0,0,0.08974358974358974,20.08974358974359,15.08974358974359)" fill="#111">
        ...
        <g id="SvgjsG1496" featurekey="nameLeftFeature-0"
            transform="matrix(1.187835527572395,0,0,1.187835527572395,120.61665785069147,17.436708147377093)" fill="#fff">
            <path
        ...
        <g id="SvgjsG1498" featurekey="nameRightFeature-0"
            transform="matrix(1.1896802013630317,0,0,1.1896802013630317,210.62092196274875,17.29354890619188)" fill="#fff">
            <path
