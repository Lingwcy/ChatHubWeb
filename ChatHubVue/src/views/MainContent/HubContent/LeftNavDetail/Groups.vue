...
import { appsetting, UseUserInformationStore, UseServiceStore, UseFriendsStore, UseMsgStore, UseChatStore } from '../../../../store/index'
...
<template>
    <Add class="Compoents"></Add>
    <div id="friends-header">
        <el-button plain @click="getFriendsReq">创建</el-button>
        <el-button plain @click="appset.CompoentsEvent.isAddOpen = true">加入</el-button>
