...
import { UseServiceStore, UseChatStore, UseMsgStore, UseFriendsStore, UseGroupStore } from '../../../store/index'
...
function exitLogin() {
    service.ChatHub?.HubConnection.stop()
    userInfo.logout()
...
<template>
    <div id="LeftNav-Container">
        <div class="LeftNav-Container-items">
            <div id="UserMsg">
                <el-popconfirm confirm-button-text="修改资料" cancel-button-text="退出登录" cancel-button-type="success"
                    title="配置您的个人信息来获得更高的辨识度" icon-color="#626AEF" @confirm="confirm()" @cancel="exitLogin()">
                    <template #reference>
                        <el-button
                            style="border-radius: 50px; width: 100%; height: 100%; overflow: hidden; box-sizing: border-box;">
