                            ...
                            <el-scrollbar ref="myScrollbar">
                                <div id="messageRES" v-for="(_msg, index) in item.targetUserMessage.messageHeaders"
                                    ...
                                    <div id="messageRES-Header">
                                        <span style="margin-left: 3px;">{{ item.targetUserMessage.messageNames[index]
                                            }}</span>
                                        ...
                                        <el-popover placement="top" :width="500" trigger="hover">
                                            ...
                                            <template #reference>
                                                <el-button
                                                    ...
                                                    <svg t="1671526051283" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8575"
                                                        width="25" height="25">
                                                        <path
                                    ...
                                    <div class="tools-item">
                                        <el-popover placement="top" :width="500" trigger="click">
                                            ...
                                            <template #reference>
                                                <el-button
                                                    style="height: 35px; width: 35px; margin-bottom: 10px; background-color: whitesmoke; ">
                                                    <svg t="1671525958216" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7208"
                                                        width="20" height="20">
                                                        <path d="M0 0h1024v1024H0z" fill="#707070" fill-opacity="0"
                                                            p-id="7209">
                                                        </path>
                                                        <path
                    ...
                    <div v-if="item.tabType == 1" class="msgTabContent-GroupOption">
                        ...
                        <div class="msgTabContent-GroupOption-advertising">
                            <div class="msgTabContent-GroupOption-advertising-option"
                                ...
                                <img class="group-option" src="../../../images/assets/设置.svg" @click="drawer = true"/>

                            </div>
                            <div class="msgTabContent-GroupOption-advertising-title">
                            ...
                            <div class="msgTabContent-GroupOption-advertising-content">
                                <el-scrollbar height="140px" :always="false"
                                    class="msgTabContent-GroupOption-advertising-content-text">
                                    <p>{{ groupStore.OnConnectedGroup.GroupInfo.GroupDescription }}</p>
                                </el-scrollbar>
                            </div>
                        </div>
                        <div class="msgTabContent-GroupOption-members">
                            <div class="msgTabContent-GroupOption-members-title">
                                ...
                                <p style=" margin-right: 25px;">1256</p>
